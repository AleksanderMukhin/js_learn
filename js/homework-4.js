...
// const totalPlayTime = playtimes.reduce((totalPlayTime, playtimes) => totalPlayTime + playtimes, 0);
...
// const totalAveragePlaytimePerGame = players.reduce((totalAveragePlaytimePerGame, { playtime, gamesPlayed }) => 
// totalAveragePlaytimePerGame + playtime / gamesPlayed, 0);
...
// ];
// //-------REDUCE---------------
// //----eto pushit vse massivu-------
// // const arrayOfArrays = users.reduce((array, {friends}) => {
// //   array.push(friends);
// //   return array;
// // }, []);

// //----eto pushit vse massivu v odin massiv-----
// // const arrayOfArrays = users.reduce((array, {friends}) => {
// //   array.push(...friends);
// //   return array;
// // }, []);

// //----eto toge pushit vse massivu v odin massiv-----
// // const arrayOfArrays = users.reduce((accum, { friends }) =>
// //   [...accum, ...friends], []);
// // console.log(arrayOfArrays);

// // const friendsStat = arrayOfArrays.reduce((acc, name) =>
// //   ({...acc,
// //     [name]: acc[name] ? acc[name] + 1 : 1}), {})

// // console.log(friendsStat);
// //------------------------------------------------


// //-------------SORT--------------
// //---sortirovka po chisly----
// const sortBigestBalance = [...users].sort((curBalance, nextBalance) =>
//   curBalance.balance - nextBalance.balance);
// console.table(sortBigestBalance);

// //--sortirovka po bukvam---------
// const sortByName = [...users].sort((curName, nextName) =>
//   curName.name.localeCompare(nextName.name));
